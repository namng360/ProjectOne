package vn.edu.poly.projectone.adapter.south;
...
public class AdapterSouthGrilled extends RecyclerView.Adapter<HolderFood> {
    private Activity activity;
    private List<Food> foodList;

    public AdapterSouthGrilled(Activity activity, List<Food> foodList) {
