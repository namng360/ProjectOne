...
public class NorthernActivity extends AppCompatActivity {
    ...
    private AdapterNorthern adapterNorthern;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Glide.with(this).load(R.drawable.mienbac).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
        initView();
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle(getString(R.string.northern));
    ...
    private void initView() {
        ...
        adapterNorthern = new AdapterNorthern(this, foodList);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        rcView.setLayoutManager(mLayoutManager);
        rcView.setAdapter(adapterNorthern);
    }
    ...
    private void initData() {
        ...
        foodList.add(food);
        adapterNorthern.notifyDataSetChanged();
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.idDiary) {
            Intent intent = new Intent(NorthernActivity.this, DiaryActivity.class);
            startActivity(intent);
            return true;
        }if (id == R.id.idLanguage){
            Intent intent = new Intent(NorthernActivity.this, ChageLanguageActivity.class);
            startActivity(intent);
        }
