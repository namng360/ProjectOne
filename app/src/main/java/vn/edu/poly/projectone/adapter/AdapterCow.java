...
public class AdapterCow extends RecyclerView.Adapter<HolderFood> {
    private Activity activity;
    private List<Model> modelList;

    public AdapterCow(Activity activity, List<Model> modelList) {
    ...
    public HolderFood onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_northern_cow,viewGroup,false);
